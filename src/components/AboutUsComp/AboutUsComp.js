...
export default function AboutUsComp () {
    ...
    const team = [
        ...
        { index: 1, name: 'Alberto', lastname: 'Díaz Lugo', github: 'https://github.com/andresDiazLugo', linkedin: 'https://www.linkedin.com/in/alberto-andres-diaz-lugo-91b0a0239', photo: alberPic, description: 'El loquito más picante del condado' },
